...
class BuharKazani extends StatelessWidget {
  @override
                            ...
                            RaisedButton(padding: EdgeInsets.all(10*oran),
                              onPressed: () {
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            Webpage("http://www.enorpa.com/tr/urun/kuvars-serisi-kati-yakitli-buhar-kazani")));
                              ...
                              child: Text(
                                "Kuvars Serisi Katı Yakıtlı Buhar Kazanı",
                                textScaleFactor: oran,
                                style: TextStyle(
                                    fontFamily: 'Kelly Slab',
                                    fontSize: 18,
                            ...
                            RaisedButton(padding: EdgeInsets.all(10*oran),
                              onPressed: () {
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            Webpage("http://www.enorpa.com/tr/urun/kuvars-serisi-sivi-gaz-yakitli-buhar-kazanlari")));
                              ...
                              shape: new RoundedRectangleBorder(borderRadius: new BorderRadius.circular(20.0)),
                              child: Text(
                                "Kuvars Serisi Sıvı Gaz Yakıtlı Buhar Kazanı",
                                textScaleFactor: oran,
                                style: TextStyle(
                                    fontFamily: 'Kelly Slab',
                                    fontSize: 18,
