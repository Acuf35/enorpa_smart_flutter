...
class SicakHavaApareyi extends StatelessWidget {
  @override
                            ...
                            RaisedButton(padding: EdgeInsets.all(10*oran),
                              onPressed: () {
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            Webpage("http://www.enorpa.com/tr/urun/has-turbo-serisi-sicak-hava-apareyi")));
                              ...
                              child: Text(
                                "Has Turbo Serisi Sıcak Hava Apareyi",
                                textScaleFactor: oran,
                                style: TextStyle(
                                    fontFamily: 'Kelly Slab',
                                    fontSize: 18,
                            ...
                            RaisedButton(padding: EdgeInsets.all(10*oran),
                              onPressed: () {
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            Webpage("http://www.enorpa.com/tr/urun/has-serisi-sicak-hava-apareyi")));
                            ...
                            RaisedButton(padding: EdgeInsets.all(10*oran),
                              onPressed: () {
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            Webpage("http://www.enorpa.com/tr/urun/has-mobil-serisi-sicak-hava-apareyi")));
                              ...
                              shape: new RoundedRectangleBorder(borderRadius: new BorderRadius.circular(20.0)),
                              child: Text(
                                "Has Mobil Serisi Sıcak Hava Apareyi",
                                textScaleFactor: oran,
                                style: TextStyle(
                                    fontFamily: 'Kelly Slab',
                                    fontSize: 18,
