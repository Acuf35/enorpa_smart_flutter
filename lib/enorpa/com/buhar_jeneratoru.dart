...
class BuharJeneratoru extends StatelessWidget {
  @override
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Container(
                                ...
                                child: Text(
                                  "Sıvı - Gaz Yakıtlı Serpantinli Buhar Jeneratörü",
                                  textScaleFactor: oran,
                                  style: TextStyle(
                            ...
                            RaisedButton(padding: EdgeInsets.all(10*oran),
                              onPressed: () {
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            Webpage("http://www.enorpa.com/tr/urun/jasper-serisi-sivi-gaz-yakitli-buhar-jeneratoru")));
                              ...
                              child: Text(
                                "Jasper Serisi Sıvı Gaz Yakıtlı Buhar Jeneratörü",
                                textScaleFactor: oran,
                                style: TextStyle(
                                    fontFamily: 'Kelly Slab',
                                    fontSize: 18,
