                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.only(
                          left: 20 * oran, top: 5 * oran, bottom: 5 * oran),
                      child: RaisedButton(
                ...
                Expanded(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Container(
                        margin:
                            EdgeInsets.only(right: 30 * oran, left: 30 * oran),
                        alignment: Alignment.center,
                        color: Color.fromRGBO(216, 27, 96, 1.0),
                        height: 2,
                      ),
  ...
  _tamamlaClick() {
    if (kazan_1_aktif == "0" && kazan_2_aktif == "0")
      ...
      Toast.show(SelectLanguage().selectStrings(dilSecimi, "toast3"), context,
        ...
        sektor_4_k1 == "0" &&
        sektor_4_k2 == "0")
      Toast.show(SelectLanguage().selectStrings(dilSecimi, "toast4"), context,
          duration: 2);
    else {
      dbHelper.veriYOKSAekleVARSAguncelle(1, "ok", "0", "0", "0");
