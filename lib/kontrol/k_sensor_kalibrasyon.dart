...
class KsensorKalibrasyon extends StatefulWidget {
  String tur = "";

  KsensorKalibrasyon.deger(String x) {
    tur = x;
  }
  @override
  State<StatefulWidget> createState() {
    return  KsensorKalibrasyonState.deger(tur);
  }
}

class  KsensorKalibrasyonState extends State< KsensorKalibrasyon> {
  String tur = "";

  KsensorKalibrasyonState.deger(String x) {
    tur = x;
    print(tur);
  }
      ...
      body: Center(
        child: Container(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(
                                  child: Padding(
                                    padding: EdgeInsets.only(left: 60*oran,right: 50*oran),
                                    child: Column(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Text(SelectLanguage().selectStrings(dilSecimi, 'tv21'),textScaleFactor: oran,style: TextStyle(fontFamily: 'Kelly Slab'
          ...
          BorderRadius.all(Radius.circular(10.0))),
                              ...
                              Expanded(
                                  child: Padding(
                                    padding: EdgeInsets.only(right: 60*oran,left: 50*oran),
                                    child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                      children: <Widget>[
          ...
          borderRadius: BorderRadius.all(Radius.circular(10.0))),
                                ...
                                child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        padding: EdgeInsets.only(right: 10*oran),
                                        child: Text(SelectLanguage().selectStrings(dilSecimi, 'tv31'),textScaleFactor: oran,style: TextStyle(fontFamily: 'Kelly Slab'
                                        ,color: Colors.deepOrange.shade800,fontWeight: FontWeight.bold,fontSize: 16),textAlign: TextAlign.center,),
                                      ),
                                      Text("80.0",textScaleFactor: oran,style: TextStyle(fontFamily: 'Kelly Slab'
                                      ,color: Colors.white,fontWeight: FontWeight.bold,fontSize: 35),),
