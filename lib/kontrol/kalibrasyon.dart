...
class KalibrasyonState extends State<Kalibrasyon> {
  ...
  Widget build(BuildContext context) {
    ...
    try {
      ...
      var carpim = MediaQuery.of(context).size.width *
              ...
              children: <Widget>[
                ...
                Container(
                  margin: EdgeInsets.only(
                      top: 0, bottom: 0, left: 120 * oran, right: 120 * oran),
                  alignment: Alignment.center,
                          ...
                          children: <Widget>[
                            Expanded(
                              child: Container(
                                margin: EdgeInsets.only(
                                    right:
                                        k2_aktif == "1" ? 10 * oran : 70 * oran,
                                    left: k2_aktif == "1" ? 0 : 70 * oran),
                                child: Row(
                                  children: <Widget>[
                                    Expanded(
                                      child: Column(
